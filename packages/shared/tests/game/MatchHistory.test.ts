...
function makeMockStorage(): { adapter: StorageAdapter; store: Map<string, string> } {
...
describe('MatchHistory', () => {
  ...
  it('handles corrupted storage gracefully', () => {
    const { adapter, store } = makeMockStorage();
    setStorageAdapter(adapter);
    store.set('dicewars_match_history', 'not valid json');
